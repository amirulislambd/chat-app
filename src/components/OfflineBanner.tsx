...
export default function OfflineBanner() {
  ...
  useEffect(() => {
    ...
    setIsSocketDisconnected(!socket.connected);
  ...
  if (!isOffline && !isSocketDisconnected) return null;
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-[100] flex items-center justify-center gap-2 bg-amber-500 dark:bg-amber-600 text-white text-sm font-medium py-2 px-4 shadow-md transition-all">
